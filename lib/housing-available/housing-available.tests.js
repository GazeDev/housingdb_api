...
lab.experiment('HousingAvailable', () => {
  ...
  lab.before(async () => {
    ...
    // TODO: determine why auth isn't working;
    console.log(accountId);

    const housingAvailable = require('./housing-available.controllers.js')(sequelize.models);
    const housingAvailableLib = require('../housing-available/housing-available.controllers')(models).lib;
    parseInfo = housingAvailableLib.parseInfo;
  ...
  /**
   * Precondition: user is logged-in, has entered nothing;
   * Postcondition: no Housing Availables stored;
   * GET /accounts
   */
  lab.test('Pretest: GET /housing-available Empty', async () => {
