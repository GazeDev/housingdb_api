module.exports = (models) => {
  ...
  return {
    ...
    // getHousingAvailableSchema: function(request, h) {
    //   const convert = require('joi-to-json-schema');
    //   return convert(housingAvailableModels.api);
    // },
    ...
    postHousingAvailable: async function (request, h) {
      ...
      */
      ...
      let housingAvailableInstance = await createHousingAvailable(housingAvailableObject);
