...
module.exports = (models) => {
  ...
  return {
    ...
    getHousingAvailableById: async function (request, h) {
      let response;
      try {
        response = await models.HousingAvailable.findByPk(request.params.id);
      } catch(e) {
        throw Boom.badImplementation('Error during models.HousingAvailable.findByPk(): ', e);
      }
      return h
        .response(response);
    }
