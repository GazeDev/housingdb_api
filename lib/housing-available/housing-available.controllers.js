module.exports = (models) => {
  ...
  return {
    ...
    postHousingAvailable: async function (request, h) {
      ...
      */
      ...
      if (!ensureNonnegativeValue(bedrooms)) {
        throw Boom.badData("Bedrooms cannot be a negative number.")
      }
      ...
      if (!ensureNonnegativeValue(bathrooms)) {
        throw Boom.badData("Bathrooms cannot be a negative number.")
      }
      ...
      // This sets the AuthorId associated with this HA listing to === AuthorId of the post itself;
   ...
   /*
    * Puts a HousingAvailable object in the DB and returns an instance
    */
  ...
  // Use to ensure user doesn't enter number of bedrooms or bathrooms less than 0;
  function ensureNonnegativeValue(value) {
    return (value >= 0);
  }
