module.exports = (models) => {
  ...
  return {
    ...
    getAllExternalHousingAvailable: async function(request, h) {
      ...
      try {
        ...
        console.log(`this is returnAll: ${returnAllExternalHousingAvailable}`);
      } catch (e) {
  ...
  function getAllExternalHousingAvailable(queryParams = {}) {
    //return models.ExternalHousingAvailable.findAll()?
  ...
  function getAllExternalHousingAvailableOptions(queryParams = {}) {
    ...
    if (Object.PropertyId.hasOwnProperty.call(queryParams, 'price')) {
      whereParams = {
        [Op.or]: [
          {
            bathrooms: {
