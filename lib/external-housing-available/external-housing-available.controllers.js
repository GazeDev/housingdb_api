module.exports = (models) => {
  ...
  return {
    ...
    deleteExternalHousingAvailable: function(request, h) {
      if (request.auth.credentials.subjectId !== process.env.SUPER_ADMIN) {
        throw Boom.forbidden('Must be an admin account to delete an external housing available');
      }
      return models.ExternalHousingAvailable.destroy({
        where: {
