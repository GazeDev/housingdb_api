    ...
    return {
      postHousingWanted: async function(request, h){
        ...
        */
        ...
        if (request.AuthorId){
          housingWantedObject.AuthorId = request.AuthorId;
        }
        else{
        ...
        if (request.title){
          housingWantedObject.title = request.title;
        }
        ...
        if (request.contact){
          housingWantedObject.contact = request.contact;
        }

        if (request.body){
          housingWantedObject.body = request.body;
        }

        if (request.payload.status){
          housingWantedObject.status = request.status;
        }

        if (request.payload.details){
          housingWantedObject.details = request.details;
        }


        let housingWantedInstance = await createHousingWanted(housingWantedObject);
        
        if (request.payload.LocationIds){
