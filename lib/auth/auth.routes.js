    ...
    return [
      {
        ...
        config: {
          ...
          notes: 'Press the "Try it out!" button. This will generate a response. Just below the heading "Response Body" will be a url starting with "https://accounts.gaze.dev".Take this url and paste it in a new tab in your browser. It will take you to the login provider, where you will log in with the account you want an access code generated for. It will return you to the /auth/token url, where it should give you an access_token. Use this in the api_key box in the top right of the swagger docs.',
          tags: ['api', 'Auth'],
        }
      },
      {
